			...
			<div class="box_content">
				  ...
				  <div class="product-information">
					{block name='product_description_short'}
					  <div id="product-description-short-{$product.id}" class="product-desc" itemprop="description">{$product.description_short|truncate:400:' ...'|escape:'html':'UTF-8' nofilter}</div>
					{/block}
