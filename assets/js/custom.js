...
$(document).ready(function(){
	...
	$(".pos_content").each(function(){
	  var h = $('.js-product-miniature').outerHeight();
	  console.log(h);
	  if(h > maxheight){
		 maxheight = h;
	...
	{	
		...
		$('.product_content .item-product').each(function(index, element) {
			...
			if (cate_type == 0){
				...
				html += '<div class="img_block col-xs-4 col-sm-4 col-md-4">' + $(element).find('.img_block').html() + '</div>';
				html += '<div class="product_desc col-xs-8 col-sm-8 col-md-8">';			
				html += '<h3>'+ $(element).find('h3').html() + '</h3>';
