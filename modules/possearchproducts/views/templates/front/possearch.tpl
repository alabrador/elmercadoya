...
<div id="_desktop_search_category" class="col-md-12 col-sm-12 col-xs-12">
	<div id="pos_search_top">
		<form method="get" action="{$search_controller_url}" id="searchbox" class="form-inline form_search {if $cate_on == 1}show-categories{/if}"  data-search-controller-url="{$url_search|escape:'html'}">
			...
			<input type="text" name="s" value="{$search_string}" placeholder="{l s='Ingrese su producto de búsqueda ... ' mod='possearchproducts'}" id="pos_query_top" class="search_query form-control ac_input" >
